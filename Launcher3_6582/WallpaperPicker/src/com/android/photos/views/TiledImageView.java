...
public class TiledImageView extends FrameLayout {
    ...
    private boolean mNeedFreeTextures = false;
    
    private final static String TAG = "TiledImageView";
    ...
    public void destroy() {
        ...
        if (USE_TEXTURE_VIEW) {
            ...
            Log.i(TAG, "TiledImageView.destroy");
            mNeedFreeTextures = true;
    ...
    private Runnable mFreeTextures = new Runnable() {
        ...
        @Override
        public void run() {
            Log.i(TAG, "TiledImageView.freeTextures");
            mRenderer.image.freeTextures();
            mNeedFreeTextures = false;
        }
    };

    @Override
    protected void onDetachedFromWindow() {
        Log.i(TAG, "TiledImageView.onDetachedFromWindow");
        super.onDetachedFromWindow();
        if(mNeedFreeTextures == true) {
            mRenderer.image.freeTextures();
            mNeedFreeTextures = false;
        }
    }
    ...
    private class TileRenderer implements Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            /// M: recycled unused textures and buffers
