...
//A:JWYYL-1346 huangyouzhong 20150109 {
...
public class WallpaperCropActivity extends Activity {
	...
	protected static boolean isKeyguardWallpaper = false;// add by sunjie for keyguard wallpaper
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(LOGTAG, "isKeyguardWallpaper="+isKeyguardWallpaper);
    ...
    // Add by sunjie for keyguard wallpaper feature begin
    static protected Point getDefaultKeyguardWallpaperSize(Resources res, WindowManager windowManager) {
        ...
        if (isScreenLarge(res)) {
            ...
            defaultWidth = Math.min(minDim, maxDim);
            defaultHeight = maxDim;
        }
        return new Point(defaultWidth, defaultHeight);
    }
    // Add by sunjie for keyguard wallpaper feature end
    ...
    protected void cropImageAndSetWallpaper(
        ...
        if (isKeyguardWallpaper) {
        	outSize = getDefaultKeyguardWallpaperSize(getResources(),
                    getWindowManager());
        } else {
            ...
            if (mSetWallpaper && mNoCrop) {
                try {
                    ...
                    if (is != null) {
    					...
    					if (isKeyguardWallpaper) {
    						wallpaperManager.setStreamForKeyguard(is);
    					} else {
    						wallpaperManager.setStream(is);
    					}
                ...
                if (crop.compress(cf, DEFAULT_COMPRESS_QUALITY, tmpOut)) {
                    ...
                    if (mSetWallpaper && wallpaperManager != null) {
                        try {
							...
							if (isKeyguardWallpaper) {
								wallpaperManager.setStreamForKeyguard(new ByteArrayInputStream(outByteArray));
							} else {
								wallpaperManager.setStream(new ByteArrayInputStream(outByteArray));
							}
							// modify by sunjie for keyguard wallpaper end
