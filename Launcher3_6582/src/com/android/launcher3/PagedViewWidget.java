...
public class PagedViewWidget extends LinearLayout {
    ...
    public void applyFromAppWidgetProviderInfo(AppWidgetProviderInfo info,
        ...
        if (LauncherLog.DEBUG) {
            LauncherLog.d(TAG, "applyFromAppWidgetProviderInfo: info = " + info + ", label = " + info.label);
        }
    ...
    public int[] getPreviewSize() {
        ...
        if (LauncherLog.DEBUG) {
            if (maxSize[0] <= 0 || maxSize[1] <= 0) {
                LauncherLog.d(TAG, "getPreviewSize: maxSize[0] = " + maxSize[0] +
                   ", maxSize[1] = " + maxSize[1] +
                   ", i.getWidth() = " + i.getWidth() + ", i.getHeight() = " + i.getHeight() +
                   ", mOriginalImagePadding = " + mOriginalImagePadding);
            }
        }
