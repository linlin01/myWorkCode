...
out:            for (int i = x; i < x + spanX - 1 && x < xCount; i++) {
    ...
    public boolean isExceedLastPosition(final int[] cell) {
        final int childCount = mShortcutsAndWidgets.getChildCount();
        int pos = cell[1] * mCountX + cell[0];
    ...
    public int[] getLastPosition(final int[] cell) {
        ...
        cell[0] = childCount % mCountX;
        cell[1] = childCount / mCountX;
    ...
    public void removeChildView(final View child) {
        markCellsAsUnoccupiedForView(child);
        mShortcutsAndWidgets.removeView(child);
    }
    ...
    /**
     * M: Get child on one page.
     */
    public View getChildOnPageAt(int i) {
        return mShortcutsAndWidgets.getChildAt(i);
    }
