    ...
    private void handleTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                Trace.traceBegin(Trace.TRACE_TAG_INPUT, "PagedViewWithDraggableItems.ACTION_DOWN");
                cancelDragging();
                mIsDragEnabled = true;
                Trace.traceEnd(Trace.TRACE_TAG_INPUT);
                break;
            case MotionEvent.ACTION_UP:
                Trace.traceBegin(Trace.TRACE_TAG_INPUT, "PagedViewWithDraggableItems.ACTION_UP");
                Trace.traceEnd(Trace.TRACE_TAG_INPUT);
                break;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (LauncherLog.DEBUG_MOTION) {
            LauncherLog.d(TAG, "onInterceptTouchEvent: ev = " + ev + ", mTouchState = "
                    ...
                    + mIsDragEnabled + ", mScrollX = " + getScrollX() + ", this = " + this);
        }
