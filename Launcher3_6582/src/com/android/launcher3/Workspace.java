...
//modify by liuxianbang for launcher ani (start)
        float finalBackgroundAlpha = (stateIsSpringLoaded || stateIsOverview) ? OVERVIEW_ALPHA : 0f;
...
//modify by liuxianbang for launcher ani (end)
...
//delete by liuxianbang for Ani 20150203 (start)
           if(!mLauncher.hasScreenEffects()){
              enableFreeScroll();
            }
            //enableFreeScroll();
//delete by liuxianbang for Ani 20150203 (end)
        }
        ...
        if (animated) {
            ...
            alphaUpdateListener = new AlphaUpdateListener(searchBar);
            searchBarAlpha.addListener(alphaUpdateListener);
            //searchBarAlpha.addUpdateListener(alphaUpdateListener);
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        mDragOutline = null;
        // Add by sunjie for JWBLL-888 begin
        if (mDragInfo != null) {
        ...
        // Add by sunjie for JWBLL-888 end
        mDragInfo = null;
    }
