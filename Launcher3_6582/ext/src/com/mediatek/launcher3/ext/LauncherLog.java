...
//add by liuxianbang for Ani 20150203 (start)
    public static boolean DEBUG_ANI = true;
    public static final String PROP_DEBUG_ANI = "launcher.debug.ani";
    public static final String TAG_ANI = "ScreenEffect";
    ...
    static {
        if (android.os.SystemProperties.getBoolean(PROP_DEBUG_ALL, false)) {
            ...
            DEBUG_AUTOTESTCASE = android.os.SystemProperties.getBoolean(PROP_DEBUG_AUTOTESTCASE,
                    true);
//add by liuxianbang for Ani 20150203 (start)
            DEBUG_ANI = android.os.SystemProperties.getBoolean(PROP_DEBUG_ANI, true);
//add by liuxianbang for Ani 20150203 (end)
        }
    }
    /******************** end ********************/
