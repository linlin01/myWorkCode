...
package com.rgk.fpfeature.view;
...
public class ScrollControlLayout extends ViewGroup {
    ...
    /**
     *  Controll the scrollTime
     *  scroll duration = Math.abs(delta) * durationTime
     *  default is 2
     */
    ...
    public ScrollControlLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void snapToScreen(int whichScreen) {
        ...
        if (getScrollX() != (whichScreen * getWidth())) {
            ...
            mScroller.startScroll(getScrollX(), 0, delta, 0, Math.abs(delta) * durationTime);
