...
public class MTKUnreadLoader extends BroadcastReceiver {
    ...
    private boolean isGMms = false;
    ComponentName MmscomponentName;
    //Add BUG_ID:DWYQDSS-275 zhaopenglin 20160714(end)
    public MTKUnreadLoader(Context context) {
        mContext = context;
        //Add BUG_ID:DWYQDSS-275 zhaopenglin 20160714(start)
        isGMms = mContext.getResources().getBoolean(R.bool.gmms_unreadSupport);
        MmscomponentName = new ComponentName("com.android.mms", "com.android.mms.ui.BootActivity");
        //Add BUG_ID:DWYQDSS-275 zhaopenglin 20160714(end)
    }
